(function ($) {
  ...
  var proCata = $(".roundup-pro-catagory");
  ...
  var roundupSearch = $(".search-nav");
  var searchClose = $(".search-close");

  roundupSearch.on("click", function () {
  ...
  var roundupMobNav = $(".roundup-navbar-toggler");
  var navClose = $(".nav-close");

  roundupMobNav.on("click", function () {
